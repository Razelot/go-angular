...
func (a *App) Run(addr string) {
	...
	// need this to handle CORS
	log.Fatal(http.ListenAndServe(addr, handlers.CORS(handlers.AllowedMethods([]string{"GET", "POST", "PUT", "HEAD", "DELETE"}), handlers.AllowedOrigins([]string{"*"}))(a.Router)))
...
func (a *App) initializeRoutes() {
	...
	// a.Router.PathPrefix("/").Handler(http.FileServer(http.Dir("./client/dist/client")))
...
// 	http.ServeFile(w, r, "./client/dist/client/index.html")
// }
